...
class Geolocation(Base):
    ...
    __mapper_args__ = {"primary_key": ["geolocation_zip_code_prefix"]}
...
class OrderItems(Base):
    ...
    __mapper_args__ = {"primary_key": ["order_item_id"]}
...
class OrderPayments(Base):
    ...
    __mapper_args__ = {"primary_key": ["payment_installments"]}
    order_id = Column(String(32))
    # order_id = Column(String(32), ForeignKey('orders.order_id'))
...
class ProductCategoryNameTranslation(Base):
    ...
    __mapper_args__ = {"primary_key": ["product_category_name"]}
    product_category_name = Column(String(100))
...
class ClosedDeals(Base):
    ...
    __mapper_args__ = {"primary_key": ["sdr_id"]}
